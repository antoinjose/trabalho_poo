...
<head>
    ...
    <title>Editar Veículo - Sistema SOM</title>
        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Editar Veículo</h1>
                        <p class="text-gray-500 mt-1">Atualize os dados do veículo</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form action="{{ route('veiculos.update', $veiculo->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                        ...
                        <p><strong>Criado em:</strong> {{ $veiculo->created_at->format('d/m/Y H:i') }}</p>
                        <p><strong>Última atualização:</strong> {{ $veiculo->updated_at->format('d/m/Y H:i') }}</p>
                    </div>
